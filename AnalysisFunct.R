...
NofSim<-100
testExp<-c(0.001,0.01,0.1,1,2,3,4,5,10) 		#give the exponential rate to test against
...
#Examples
AnalysisNon(testExp,times0,NofSim,theta)
AnNon<-AnalysisNon(c(0.001,1,2,3,4,5,10) , rep(0,10)+0.3*c(1:10),100,1)	

AnNon<-AnalysisNon(c(0.0001,0.001,0.01,0.1,1,2,3,4,5,10) , rep(0,100),100,1)
...
AnExp<-AnalysisExp(c(0.0001,0.01,0.1,1,2,3,4,5,10) , rep(0,20),5,100,1)

AnExp<-AnalysisExp(c(0.1,1,5,10,15,20,50) , rep(0,20),10,100,1)
