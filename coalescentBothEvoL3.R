...
#	}else{ratioA<-ratioN}
#print (paste(as.character(ratio), "puzzola"));break
#}
...
#print(paste("Your population is expanding ",expns," Nexp at present is ", ," Nexp at Texp is ", RatioTexp, "Na is ",(1+RatioTexp),  sep=""))
...
treeX<-MakeTreeAny(timesExp=rep(0,20),timesNon=rep(0,10),alpha=5,Ts=1.05,Texp=1,ratio=5,expns="Xav")
plot.phylo(treeX)
axisPhylo()
