...
MakeTreeBoth<-function(timesExp,timesNon,alpha,Ts,Texp,ratio,expns){
...
######## evolving!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
done<-MakeTree(timesExp,alpha,ratio,expns)
while(done$height>Ts){
	done<-MakeTree(timesExp,alpha,ratio,expn)
}
...
evolvedA<-joinevolved(done$evolved,evolvedNon,Ts)
