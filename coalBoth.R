...
source("progs/coalExp2.R")
source("progs/coalNonExp.R")

#########function joinevolved
#given the two lists containing the data for the two subopulations joins them in one list (the smallest subpopulation first)
#parameters: the list containing the evolution of each subpopulation
#returns: a list containing both subpopulations
...
#############function joinevo
#joins the evolutionary matrices of the two subpopulations
#parameters: two evolutionary matrices
#returns: a joint evolutionary matrix
...
#############function makephylo
#transforms an evolutionary matrix into a tree (class phylo object)
#parameter: an evolutionary matrix
#returns: a tree (class phyo object)
...
############# MAIN FUNCTION ###############
#starting from the times at which the leaves are to appear in each subpopulation, the expansion rate of the expanding subpopulation and the times at which the two populations separate and the expanding one starts to expanding
#produces a tree
#uses frunction from "progs/coalExp2.R" and "progs/coalNonExp.R"

#parameters: TimesExp,TimesNon,alpha,Ts,Texp
#returns: a tree (phylo object)
...
timesWxp<-timesExp-min(timesExp)   # first leave at 0
